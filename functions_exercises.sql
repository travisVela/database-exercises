...
select concat(first_name, ' ',  last_name) as 'Employees with last name that begins and ends with ''e'''
from employees
...
select first_name, hire_date, curdate(), datediff(curdate(), hire_date)/365 as 'years employed'
from employees
